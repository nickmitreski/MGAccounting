    ...
    if (mobileButton) {
        mobileButton.addEventListener('click', function() {
            ...
            panel.innerHTML = `
                ...
                <div class="result-item total" style="font-size: 18px; font-weight: 600; margin-top: 15px; padding-top: 15px; border-top: 1px solid #ddd; background:${resultBg}; border-radius:8px; display:flex; align-items:center;">
                    <span style="font-weight:700;">Estimated Tax Result:</span>
                    <span style="color:${resultColor}; font-weight:700; border:2px solid ${resultColor}; border-radius:24px; padding:6px 18px; margin-left:auto; background:#fff;">${formatCurrency(refund)}</span>
                </div>
            `;
